...
# Inventory grid: direct view over the legacy parts inventory table.
#
# Instead of hardcoding a schema, we reflect the "tbl"."parts__inventory" table
...
ACCOUNTING_TRANSACTIONS_COLUMNS_META: List[ColumnMeta] = [
  ...
  ColumnMeta(name="expense_category_id", label="Category", type="string", width_default=140),
  ColumnMeta(name="storage_id", label="Storage", type="string", width_default=140),
  ColumnMeta(name="subcategory", label="Flag", type="string", width_default=140),
...
BUYING_COLUMNS_META: List[ColumnMeta] = [
  ...
  ColumnMeta(name="picture_url0", label="Picture URL 0", type="string", width_default=120),
  ColumnMeta(name="picture_url1", label="Picture URL 1", type="string", width_default=120),
  ColumnMeta(name="picture_url2", label="Picture URL 2", type="string", width_default=120),
  ColumnMeta(name="picture_url3", label="Picture URL 3", type="string", width_default=120),
  ColumnMeta(name="picture_url4", label="Picture URL 4", type="string", width_default=120),
  ColumnMeta(name="picture_url5", label="Picture URL 5", type="string", width_default=120),
  ColumnMeta(name="picture_url6", label="Picture URL 6", type="string", width_default=120),
  ColumnMeta(name="picture_url7", label="Picture URL 7", type="string", width_default=120),
  ColumnMeta(name="picture_url8", label="Picture URL 8", type="string", width_default=120),
  ColumnMeta(name="picture_url9", label="Picture URL 9", type="string", width_default=120),
  ColumnMeta(name="picture_url10", label="Picture URL 10", type="string", width_default=120),
  ColumnMeta(name="picture_url11", label="Picture URL 11", type="string", width_default=120),
...
def _inventory_columns_meta_from_reflection() -> List[ColumnMeta]:
    ...
    This uses TblPartsInventory.__table__ so that grid columns always mirror
    the real Supabase schema of tbl_parts_inventory without hardcoding it.
    """
    ...
    for col in table.columns:
        t = col.type
        logical_type = "string"
        if isinstance(t, (SA_Integer, SA_BigInteger, SA_Numeric, SA_Float)):
            logical_type = "number"
        ...
        # Money-like numerics can still be typed as "number"; formatting is done in the grid.
        cols.append(
            ColumnMeta(
                name=col.key,
                label=col.key,
...
def _columns_meta_for_grid(grid_key: str) -> List[ColumnMeta]:
    ...
    if grid_key == "inventory":
        return _inventory_columns_meta_from_reflection()
    if grid_key == "cases":
