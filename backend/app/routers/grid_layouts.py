...
ORDERS_COLUMNS_META: List[ColumnMeta] = [
  ...
  ColumnMeta(name="order_status", label="Status", type="string", width_default=120),
  ...
  ColumnMeta(name="total_amount", label="Total", type="money", width_default=120),
  ColumnMeta(name="shipping_cost", label="Shipping", type="money", width_default=120),
  ColumnMeta(name="tax_amount", label="Tax", type="money", width_default=120),
  ColumnMeta(name="currency_code", label="Currency", type="string", width_default=80),
  ColumnMeta(name="shipping_carrier", label="Carrier", type="string", width_default=140),
  ColumnMeta(name="tracking_number", label="Tracking", type="string", width_default=200),
  ColumnMeta(name="payment_date", label="Payment date", type="datetime", width_default=180),
  ColumnMeta(name="payout_date", label="Payout date", type="datetime", width_default=180),
]

TRANSACTIONS_COLUMNS_META: List[ColumnMeta] = [
  ColumnMeta(name="sale_date", label="Sale date", type="datetime", width_default=180),
  ...
  ColumnMeta(name="buyer_username", label="Buyer", type="string", width_default=180),
  ColumnMeta(name="sale_value", label="Sale value", type="money", width_default=120),
  ...
  ColumnMeta(name="shipping_charged", label="Shipping", type="money", width_default=120),
  ColumnMeta(name="tax_collected", label="Tax", type="money", width_default=120),
  ColumnMeta(name="profit", label="Profit", type="money", width_default=120, sortable=True),
  ColumnMeta(name="profit_status", label="Profit status", type="string", width_default=140),
  ColumnMeta(name="payment_status", label="Payment", type="string", width_default=140),
  ColumnMeta(name="fulfillment_status", label="Fulfillment", type="string", width_default=140),
]
